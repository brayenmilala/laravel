...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>78</td>
      <td>
      <a href="" class="badge-success">enter </a>
      <td><output>86.3</td>
      <td>
  ...
  <tbody>
    <tr>
      ...
      <td>80</td>
      <td>88</td>
      <td><a href="" class="badge-success">enter </a>
      <td><output>85.3</td>
      <td>
        <a href="" class="badge-success">edit |</a>
        <a href="" class="badge-danger">delete </a>
...
<table class="table">
        ...
        <tbody>
                <tr>
                    ...
                    <td>
                        <?php
                        echo "nilai max id 1="; echo  max(88,93,78);
                        ?>
                    </td>
                    <td>
                        <?php
                        echo "   nilai min id 1=";echo min(88,93,78);
                        ?> 
                    </td>
                </tr>
        </tbody>
...
Catatan:-untuk bagian input dapat dilakukan di navbar "nilai"
        mohon maaf masih percobaan dan masih ada beberapa error-
                <!-- /. tools -->
              </div>
              <!-- /.card-header -->
